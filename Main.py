...
def TempSweepIV():
    ...
    smu1_mode_frame = tk.Frame(top_opts)
    smu1_mode_frame.grid(row=0, column=1, columnspan=2, sticky='w', padx=(4, 10))
    tk.Radiobutton(smu1_mode_frame, text="2 Point", variable=smu1_4wire, value=0, indicatoron=False, width=10).pack(side=tk.LEFT, padx=(0, 2))
    tk.Radiobutton(smu1_mode_frame, text="4 Point", variable=smu1_4wire, value=1, indicatoron=False, width=10).pack(side=tk.LEFT)

    tk.Checkbutton(top_opts, text="Use SMU2", variable=use_smu2).grid(row=1, column=0, sticky='w', padx=4)
    smu2_mode_frame = tk.Frame(top_opts)
    smu2_mode_frame.grid(row=1, column=1, columnspan=2, sticky='w', padx=(4, 10))
    tk.Radiobutton(smu2_mode_frame, text="2 Point", variable=smu2_4wire, value=0, indicatoron=False, width=10).pack(side=tk.LEFT, padx=(0, 2))
    tk.Radiobutton(smu2_mode_frame, text="4 Point", variable=smu2_4wire, value=1, indicatoron=False, width=10).pack(side=tk.LEFT)
